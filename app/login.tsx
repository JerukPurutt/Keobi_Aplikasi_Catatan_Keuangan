// Login Screen for Keobi - Redesigned to match mockup
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isValid) {
        ...
        // If the user has a PIN enabled and set up, go to PIN page; otherwise, directly go to the dashboard tabs
        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.row}>
              ...
              <TouchableOpacity onPress={() => Alert.alert('Info', 'Fitur reset sandi untuk akun offline dapat dilakukan dengan register akun baru.')}>
                <Text style={styles.forgotText}>Forget password</Text>
              </TouchableOpacity>
            </View>

            {/* Login Button with Linear Gradient matching premium mockup */}
            <TouchableOpacity 
